  ...
  return (
    <header className="sticky top-0 z-40 glass-effect">
      <div className="flex items-center justify-between px-5 py-3">
        ...
        <button onClick={() => navigate("/profile")} aria-label="Open profile"
          className="w-8 h-8 flex items-center justify-center rounded-full bg-transparent border border-[#059669] active:scale-90 transition-transform duration-150"
        >
        ...
        <div className="flex items-center">
          ...
          <span className="text-[17px] font-extrabold text-foreground tracking-tight">FX</span>
          <span className="text-[17px] font-extrabold text-[#059669] tracking-tight">dream</span>
          <span className="text-[17px] font-extrabold text-foreground tracking-tight">11</span>
        </div>

        <div className="flex items-center gap-2">
          {/* <ThemeToggle theme={theme} toggleTheme={toggleTheme} /> */}
          <button onClick={toggleTheme} className="w-8 h-8 flex items-center justify-center rounded-full bg-transparent border border-[#059669] active:scale-90 transition-transform duration-150">
            {theme === "dark" ? <Sun size={16} className="text-[#059669]" /> : <Moon size={16} className="text-[#059669]" />}
          </button>
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded-full bg-transparent border border-[#059669] relative active:scale-90 transition-transform duration-150">
